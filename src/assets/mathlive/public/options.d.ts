...
export declare type VirtualKeyboardTheme = 'apple' | 'material' | '';
export declare type CombinedVirtualKeyboardOptions = Omit<VirtualKeyboardOptions, 'virtualKeyboardToggleGlyph' | 'virtualKeyboardMode'> & CoreOptions;
export declare type RemoteVirtualKeyboardOptions = CombinedVirtualKeyboardOptions & {
    /**
...
export declare type ContentChangeOptions = {
    data?: string | null;
...
export declare type AutoRenderOptions = Partial<TextToSpeechOptions> & {
    /**
     * A URL fragment pointing to the directory containing the fonts
     * necessary to render a formula.
     *
