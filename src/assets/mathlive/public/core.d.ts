...
export declare type LatexSyntaxError<T = ParserErrorCode> = {
    code: T;
    arg?: string;
    latex?: string;
    before?: string;
...
export declare type ErrorListener<T = ParserErrorCode> = (err: LatexSyntaxError<T>) => void;
/**
 ...
 */
export declare type MacroDictionary = Record<string, string | Partial<MacroDefinition> | MacroPackageDefinition>;
